import { addStoryGuest } from "../../data/api";
...
export default class GuestStoryPage {
  async render() {
    return `
      <section class="page-transition text-center">
        <h1>Tambahkan Story Kamu (Mode Guest)</h1>
        <form id="guest-form" class="story-form">
  ...
  async afterRender() {
    ...
    form.addEventListener("submit", async (e) => {
      ...
      try {
        await addStoryGuest({ description, photo: photoBlob, lat, lon });
